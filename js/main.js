...
/*------------------------------------------------------------------------------*/
    ...
    $(".testimonial-slider").owlCarousel({
        ...
        dots: false,
        navText: [
            "<a class='arrow-btn flex-center'><i class='fas fa-arrow-left'></i></a>",
            "<a class='arrow-btn flex-center'><i class='fas fa-arrow-right'></i></a>",
        ],
        responsive: {
            0: {
                items: 1,
    ...
    $(".slider-type-blog").owlCarousel({
        ...
        autoplayHoverPause: true,
        navText: [
            "<i class='fas fa-arrow-left transform-v-'></i>",
...
/*------------------------------------------------------------------------------*/
    ...
    $(".gallery-wrapper .row .col-md-6").each(function () {
        $(this).find(".blog-box>a").magnificPopup({
            type: 'image',
            gallery: {
                enabled: true,
            },
        });
        $(this).find(".gallery-items").magnificPopup({
            delegate: 'a',
            type: 'image',
            gallery: {
                enabled: true,
